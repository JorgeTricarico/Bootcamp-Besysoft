...
public class PersonajeControlador {
    ...
    public List<Personaje> mostrarTodos(){
        ...
        return GeneradorDummyn.listaDePersonajes;
    }
    ...
    public List<Personaje> buscarPersonajePorNombre(@PathVariable String nombre){
        ...
        List<Personaje> listaPersonajes = GeneradorDummyn.listaDePersonajes.stream()
                .filter(pelis -> pelis.getNombre().toLowerCase().contains(nombre.toLowerCase()))
